...
INSERT INTO `mediaapp`.`rol_usuario` (`id_rol`, `nombre`, `descripcion`) VALUES ('1', 'admin', 'Tiene todos los permisos');
INSERT INTO `mediaapp`.`rol_usuario` (`id_rol`, `nombre`, `descripcion`) VALUES ('2', 'moderador', 'Solo tiene permisos especiales');
INSERT INTO `mediaapp`.`rol_usuario` (`id_rol`, `nombre`, `descripcion`) VALUES ('3', 'user', 'Usuario normal');
